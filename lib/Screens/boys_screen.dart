      ...
      children: [
        Scaffold(
          appBar: AppBar(
            ...
            title: Text(listAllBoys==null||listAllBoys.isEmpty?name:"$name (${listAllBoys.length})",style: const TextStyle(color: Colors.white,fontSize: 20,fontWeight: FontWeight.bold)),
          ),
          body: StreamBuilder(
                ...
                child: ListView.builder(
                  ...
                  itemBuilder: (_,index){
                    return Card(
                      ...
                      child: NameItem(id: listAllBoys[index].id,name: listAllBoys[index].name, gender: listAllBoys[index].gender, typeUser: listAllBoys[index].typeUser,code: listAllBoys[index].code,classNumber: listAllBoys[index].classNumber, deleteItem: (id) async {
